/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ingest.jsonc --env-interface=IngestEnv ingest-env.d.ts` (hash: a6e6f4dd44ef8d18d24a8231d5d086a2)
