/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ingest.jsonc --env-interface=IngestEnv ingest-env.d.ts` (hash: 6cd4cba7cac6beaef7fe5bc5e0f2ee9b)
...
interface __BaseEnv_IngestEnv {
	...
	API_FOOTBALL_MAX_DEEP_FIXTURES: "8";
