...
- `football-data.org`와 API-Football adapter는 구현되어 있으나 운영 검증이 끝날 때까지 비활성화
...
- 변경된 행만 갱신하는 조건부 upsert로 동일한 전체 시즌의 반복 D1 쓰기를 방지
...
- TypeScript 통과
- ESLint 통과
- provider·경기 통계·실시간 스코어·Cron 시간표·한국어 표기 테스트 17개 통과
