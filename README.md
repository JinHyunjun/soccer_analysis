...
- 운영 기술을 공개하는 `/tech-stack`과 Notion 원본을 5분 D1 캐시로 연결한 `/releases`
- Notion 동기화 상태를 포함하는 릴리즈 JSON `/api/releases`
...
- TypeScript 통과
- ESLint 통과
- provider·경기 통계·실시간 스코어·Cron 시간표·한국어 표기·요청 예산·Notion 릴리즈 파서 테스트 24개 통과
