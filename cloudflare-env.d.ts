/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: c39501f61dfe98b298a334c4b780a998)
// Runtime types generated with workerd@1.20260701.1 2026-07-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	NOTION_RELEASE_PAGE_ID: "396cb889-5490-8174-8930-d92fd26da2b4";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOTION_RELEASE_PAGE_ID">> {}
}
